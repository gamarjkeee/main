        ...
        if (bodyLockStatus) {
            ...
            setTimeout((() => {
                for (let index = 0; index < lock_padding.length; index++) {
                    ...
                    if (el.classList.contains("social")) el.style.right = "20px";
                }
    ...
    let bodyLock = (delay = 500) => {
        ...
        if (bodyLockStatus) {
            ...
            for (let index = 0; index < lock_padding.length; index++) {
                ...
                let widthScrollBar = window.innerWidth - document.querySelector(".wrapper").offsetWidth;
                if (el.classList.contains("social")) el.style.right = 20 + widthScrollBar / 2 + "px";
            }
